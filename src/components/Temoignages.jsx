// ==============================
// Temoignages.jsx
// Copie ce fichier dans : src/components/Temoignages.jsx
// ==============================
...
function Temoignages() {
  ...
  return (
    ...
    // ===== SECTION ENTIÈRE (fond crème) =====
    <section className="bg-[#f0ede8] py-20 px-8">

      {/* ===== EN-TÊTE : tag + titre + sous-titre ===== */}
      ...
      <div className="grid grid-cols-3 gap-6 max-w-6xl mx-auto">
        ...
        {/* On boucle sur chaque témoignage */}
        {temoignages.map((t) => (
