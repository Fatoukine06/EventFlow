...
export default function Connexion() {
    return (
        <div className="bg-[#f8dfcc85]  min-h-screen flex items-center justify-center">
            <div className="h-140 w-240 border border-[#f9b785] bg-white  rounded-[40px] flex flex-row justify-between items-center  ">
                <div className=" h-full w-full  flex justify-center items-center">
                    <div className="w-100 h-115   rounded-[20px] shadow-xl flex flex-col  px-7 py-5 gap-4">
                        ...
                        <h1 className="text-2xl  font-medium text-[#533722]">Connectez-vous</h1>
                        ...
                        <div className="flex justify-center mt-2">
                            <button className="bg-[#f9b785] text-white rounded-[20px] py-2 px-4 hover:bg-[#f9b785cc] transition-colors duration-300">Se connecter</button>
                        </div>
                        <p className="text-sm text-center text-[#533722]">Pas de compte ? <Link to="/inscription" className="text-[#f9b785] hover:underline">S'inscrire</Link></p>
                    </div>
                </div>
