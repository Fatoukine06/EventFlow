...
export default function TabBord() {
    return (
        ...
        <div className="flex justify-center mt-8">
            <Link to="/Page" className="flex items-center gap-2 px-6 py-3 rounded-lg bg-amber-950 text-white hover:bg-amber-800 transition">
            <button>Accedez au dashboard</button>
